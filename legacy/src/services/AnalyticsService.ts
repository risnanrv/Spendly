...
/**
 * AnalyticsService generates intelligent financial insights and readable cards
 * from ReportData. All message composition lives here — the UI only renders the output.
 */
export class AnalyticsService {
  /**
   * Generates a full set of insight cards for the current reporting period.
   */
  generateInsights(
    report: ReportData,
    budget: BudgetContext,
    ...
    // Fastest growing category: compare current vs prev report
    ...
    // Limit to 6 most relevant insights to avoid overwhelming the user
    return {
